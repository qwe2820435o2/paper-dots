                ...
                <div className="grid items-center gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.06fr)]">
                    ...
                    <div
                        ...
                        dangerouslySetInnerHTML={{
                            __html: heroArtSvg({
                                yourPhoto: t("art.yourPhoto"),
                                readyToPost: t("art.readyToPost"),
                            }),
                        }}
                    />
                </div>
