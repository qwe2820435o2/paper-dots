    ...
    return (
        <div className="px-4 py-4 flex flex-col gap-5">
            <div className="flex items-center justify-between">
                <label className="text-[11px] uppercase text-[#64748b] tracking-[0.08em]">{t("polkaDot.transform.heading")}</label>
                <button
                    type="button"
            ...
            <div>
                <div className="flex items-baseline justify-between mb-2">
                    <label className="text-[11px] uppercase text-[#64748b] tracking-[0.08em]">{t("common.rotation")}</label>
            ...
            <div>
                <div className="flex items-baseline justify-between mb-2">
                    <label className="text-[11px] uppercase text-[#64748b] tracking-[0.08em]">{t("polkaDot.transform.skewX")}</label>
            ...
            <div>
                <div className="flex items-baseline justify-between mb-2">
                    <label className="text-[11px] uppercase text-[#64748b] tracking-[0.08em]">{t("polkaDot.transform.skewY")}</label>
            ...
            <div>
                <div className="flex items-baseline justify-between mb-2">
                    <label className="text-[11px] uppercase text-[#64748b] tracking-[0.08em]">{t("polkaDot.transform.zoom")}</label>
