...
/** The illustration (`hero-before-after.png`) has its "your photo" / "ready to post" captions
 *  baked into the raster, so it stays English in every locale — swapping it out needs new art,
 *  not a translation. Everything typeset here goes through the message files, and `sans-serif`
 *  resolves to a face with CJK coverage, so Japanese renders rather than tofu. */
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", gap: 10 }}>
            {[t("pillFree"), t("pillNoSignUp"), t("pillInstant")].map((label) => (
              <div
                key={label}
                style={{
                  display: "flex",
                  padding: "8px 18px",
                  borderRadius: 999,
                  background: "rgba(197,232,154,0.08)",
                  color: "#C5E89A",
                  fontSize: 15,
                  fontWeight: 500,
                }}
