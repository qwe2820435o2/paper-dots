...
export default function DecorateApp() {
  ...
  const activeLabel = activePanel ? t(`dot.tabs.${activePanel}`) : null;
        ...
        {TOOLS.map(({ id, icon: Icon }) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[10px] leading-none font-semibold">{t(`dot.tabs.${id}`)}</span>
            </button>
          );
        })}
      </div>
