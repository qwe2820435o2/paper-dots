...
/** `id` doubles as the key under `editor.polkaDot.tabs`. */
const TOOLS: { id: Panel; icon: typeof Grid3x3 }[] = [
    { id: "grid", icon: Grid3x3 },
    { id: "transform", icon: RotateCw },
...
export default function PolkaDotApp() {
    ...
    const activeLabel = activePanel ? t(`polkaDot.tabs.${activePanel}`) : null;
                ...
                {TOOLS.map(({ id, icon: Icon }) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <span className="text-[10px] leading-none font-semibold">{t(`polkaDot.tabs.${id}`)}</span>
                        </button>
                    );
                })}
            </div>
